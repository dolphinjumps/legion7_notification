...
* Setup
  ...
  - Install [[https://chromedriver.chromium.org/downloads][Chrome Driver]] and Specify its path in legion_notify.py CHROME_DRIVER_PATH (replace current value: /usr/bin/chromedriver) if it is different OS or installation PATH
